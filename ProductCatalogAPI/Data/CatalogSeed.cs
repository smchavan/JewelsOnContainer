    ...
    public static class CatalogSeed
    {
        ...
        private static IEnumerable<CatalogItem> GetPreConfiguredCatalogItems()
        {
            return new List<CatalogItem>
                ...
                new CatalogItem() { CatalogTypeId = 3, CatalogBrandId = 3, Description = "You are tthe star", Name = "Elequent", Price = 123, PictureUrl = "http://externalcatalogbaseurltobereplaced/api/pic/13" },
